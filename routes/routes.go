...
func Setup(app *fiber.App) {
	...
	api.Get("/credit-proof-of-ownership", creditTermsController.GetProofOfOwnership)
	api.Get("/credit-form-of-binding", creditTermsController.GetFormOfBinding)
	api.Get("/credit-collateral-classification", creditTermsController.CollateralClassification)
	api.Get("/credit-currency", creditTermsController.GetCreditCurrency)
	api.Get("/credit-assessment-by", creditTermsController.GetAssessmentBy)
